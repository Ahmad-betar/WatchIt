  ...
  return (
    <Fragment>
      <div className={classes.media}>
        <div className={classes.shadow}>Actors</div>
      </div>
      <Switch>
            ...
            {results.length === 0 && value.trim().length === 0 && (
              <Fragment>
                <ul className={classes.ul}>
                  {people.map((actor) => {
                    return (
                      <li className={classes.actor} key={actor.id}>
                ...
                <button className={classes.view} onClick={viewMoreHandler}>
                  View more
                </button>
              </Fragment>
            )}
